...
From both our case-studies we got an indication on what issues were brought to the retrospective. From our breadth study we learned of which areas in general topics originated from. From our depth study we found which topics from our categories, described in \autoref{method:categories}, were mostly influencing the retrospective. Below we will first describe the general results and then follow with the results from the depth study describing each category-set. 
...
\paragraph{Scenario Template}\label{results-ca-scenario-template}
...
\paragraph{Developer-Tester Communication}
...
\todo[inline]{Suggest moving this to discussion at the meta retrospective.}
\begin{table}[!h]
	\begin{center}
