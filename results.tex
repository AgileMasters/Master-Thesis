...
\section{Feedback session 4: retrospective with whole team}
...
\todo[inline]{Alf: Add Bravo and Golf results}
\begin{table}[!h]
	\begin{center}
...
\todo[inline]{Alf: Add Bravo and Golf results if any}
\begin{table}[!h]
	\begin{center}
...
\begin{table}[!h]
	...
	\makebox[\textwidth]{%
		...
		No reflection & Delta, Echo, Foxtrot \\
		\hline
		\end{tabular}
	}
	\end{center}
