...
>>>>>>> abb8d4ab5799f02d9f62359f381313a32ad62d2e
...
\begin{table}[!h]
	...
	\makebox[\textwidth]{%
		\begin{tabular}{ l | l }
			...
			\hline
			asdf & KJ-session \\
			asdf & Team Discussion \\
			asdf & Varying Techniques \\
			asdf & Team Barometer \\
		\end{tabular}
	}
	\end{center}
...
\begin{table}[!h]
	...
	\makebox[\textwidth]{%
		...
		\hline
		asdf & Every week & 1 hour \\
		asdf & End of every sprint & 1-2 hours \\
		asdf & Every second week up to six months & 0.5-4 hours \\
		asdf & End of every released feature & 1-2 hours \\
		asdf & On request by team member & 1-2 hours \\
		\hline
		\end{tabular}
	}
	\end{center}
...
\begin{table}[!h]
	...
	\makebox[\textwidth]{%
		...
		\hline
		asdf & Assigning Name to action & Yes \\
		asdf & Assigning to group & No \\
		asdf & Adding to backlog & No \\
		asdf & Visualizes Action & Yes \\
		asdf & Handled by SCRUM-master & Yes \\
		\hline
		\end{tabular}
	}
	\end{center}
...
\begin{table}[!h]
	...
	\makebox[\textwidth]{%
		...
		\hline
		asdf & Personality & SCRUM-masters who is not motivated to do retrospective creates low enthusiasm in the group. \\
		asdf & Timespan between retrospectives &  Having too long timespans between retrospectives creates more topics which takes longer to discuss and thus is unproductive. \\
		\hline
		\end{tabular}
	}
	\end{center}
...
\begin{table}[!h]
	...
	\makebox[\textwidth]{%
		\begin{tabular}{ l | l | p{0.3\textwidth}}
			External facilitator & Number of Teams & Teams \\
			\hline
			Used external facilitator & 2 & fafdasdaw \\
			No external facilitator & 3 & asdadsas \\
		\end{tabular}
	}
	\end{center}
\end{table}
...
\begin{table}[!h]
	...
	\makebox[\textwidth]{%
		...
		\hline
		asdf & Five times Why & TODO: Find some literature on this! \\
		asdf & Team Discussion & A discussion in the team where one discusses the issue until one find an action such that the issue won't resurface. \\
		\end{tabular}
	}
	\end{center}
\end{table}
...
\begin{table}[!h]
	...
	\makebox[\textwidth]{%
		\begin{tabular}{ l | p{0.5\textwidth} | l}
			...
			\hline
			Low enthusiasm & Participants finds the retrospective a waste of time and would rather do something else & asdsafasad \\
			Change & Without process improvement and visible changes the enthusiasm for the retrospective would decrease between the participants. & Asdasdaf \\
			External parties &  Leadership, customers or other third parties could reject the teams from implementing actions & asdasdasf \\
		\end{tabular}
	}
	\end{center}
\end{table}
...
\label{question-19}
On the topic of norms or cultural differences having an impact most interview subjects reported low or nor impact. Team alpha reported some issues 
