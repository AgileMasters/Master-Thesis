...
\todo[inline]{Skriv og knytt til litteratur}
\paragraph{Improves Efficiency}
Team Echo's practice changes from SCRUM to KANBAN and then to modified SCRUM and Team Zulu's ``Bug-crunch day'' is just two of the examples we have seen that the teams have created improvement opportunities.
\todo[inline]{Skriv og knytt til litteratur}
