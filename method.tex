...
\todo[inline]{litt mindre bråstart? Introduksjon?}
...
\todo[inline]{Synes det er litt tynt med begrunnelser her ``hvorfor har vi disse 5 seksjonene?''}
...
\todo[inline]{Skriv litt til om det å ha det på mail og legg inn svarene.}

\subsection{Interview Subjects }
\label{subsec:Interview-Subjects}
\todo{Add criteria for interview subjects like product developers, consultants and etc. }
In order to select interview subjects within the industry were contacted through mail or telephone. As well as consulting our advisors. We wanted subject with experience both holding and participating in retrospectives in order to gain multiple view of the retrospective experience. 

\section{Analysis Method}
\todo[inline]{Bjodol: Write this section}
...
\todo[inline]{Alf: Write About team Bravo}
...
\todo[inline]{Alf: Write About team Golf}
