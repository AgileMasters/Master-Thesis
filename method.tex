...
\todo[inline]{Add some more references from literature}
...
Action that are categorized as documentation is those that are related to the documentation part of developing a system. Typical actions are those that describe or propose changes to documentation practices.
\paragraph{Builds}
