...
Development includes the writing of code, as well as the designing of the system. 
\paragraph{Testing}
...
The documentation is related to the description of the work process, as well as any tutorials written in order to explain and make the product more user friendly.
\paragraph{Builds}
This category was included at the request of the project team who wrote the reports. The action points included here is related to building problem of issues with the product.
\paragraph{Release}
A release issue relates to a release of the product, typically a new version or some sort of iteration. Usually this means a commercial release where the new product is made available to the customer.
\paragraph{Business}
Business issues are not necessarily technical or business related, but may be business decisions that the team either considers or reacts to.
\paragraph{Undefined}
If an issue is not clearly explained or does not fall within the other categories it is placed in the undefined category.
